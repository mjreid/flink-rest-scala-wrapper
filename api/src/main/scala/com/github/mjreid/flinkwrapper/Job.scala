...
case class OptimizerProperties(
  ...
  compilerHints: Map[String, String]
)

object OptimizerProperties {
  implicit val reads: Reads[OptimizerProperties] = (
    (JsPath \ "global_properties").read[Map[String, String]](Readers.flinkKeyValueReader) and
      (JsPath \ "local_properties").read[Map[String, String]](Readers.flinkKeyValueReader) and
      (JsPath \ "estimates").read[Map[String, String]](Readers.flinkKeyValueReader) and
      (JsPath \ "costs").read[Map[String, String]](Readers.flinkKeyValueReader) and
      (JsPath \ "compiler_hints").read[Map[String, String]](Readers.flinkKeyValueReader)
